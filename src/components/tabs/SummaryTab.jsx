    ...
    <div className="space-y-12 select-none">
      <div className="space-y-6">
        ...
        <h2 className="text-4xl md:text-6xl font-display font-bold text-white tracking-tighter leading-[0.95]">
          Securing the <br />
          <span className="bg-gradient-to-r from-blue-400 to-[#1793d1] bg-clip-text text-transparent">Digital Frontier.</span>
        </h2>
        <p className="text-xl text-zinc-400 leading-relaxed max-w-2xl font-light">
          Passionate about <span className="text-white font-medium border-b border-[#1793d1]/30">Cybersecurity and AI</span>. 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-12">
        <div className="p-8 rounded-[32px] bg-white/[0.02] border border-white/[0.05] space-y-4 hover:bg-white/[0.04] transition-all group">
          <div className="w-12 h-12 rounded-2xl bg-[#1793d1]/10 flex items-center justify-center transition-colors group-hover:bg-[#1793d1]/20">
            <Cpu className="w-6 h-6 text-[#1793d1]" />
          </div>
          <h3 className="text-white font-display text-xl font-bold tracking-tight">AI & Python Specialist</h3>
