  ...
  return (
    <div className="space-y-12 pb-20 select-none">
      <div className="space-y-4">
        <Badge className="bg-emerald-500/10 text-emerald-500 border-emerald-500/20 px-4 py-1.5 text-[10px] font-bold tracking-[0.2em] uppercase rounded-full">Academic History</Badge>
        <h2 className="text-3xl md:text-5xl font-display font-bold text-white tracking-tighter">Scholastic <span className="text-zinc-500">Milestones.</span></h2>
      ...
      <div className="space-y-6">
        {[
          ...
          >
            <div className="text-emerald-500 font-mono text-xs sm:w-32 shrink-0 group-hover:text-emerald-400 transition-colors mb-2 sm:mb-0 pt-1 font-bold tracking-[0.1em]">{ed.year}</div>
            <div className="space-y-2">
              <h4 className="text-xl md:text-2xl text-white font-display font-bold tracking-tight">{ed.deg}</h4>
              <p className="text-emerald-500/60 text-xs font-mono uppercase tracking-widest font-bold">{ed.inst}</p>
